defmodule MvcMovieWeb.MovieControllerTest do
  use MvcMovieWeb.ConnCase

  alias MvcMovie.Movies

  @create_attrs %{gender: "some gender", price: 120.5, release_date: ~D[2010-04-17], title: "some title"}
